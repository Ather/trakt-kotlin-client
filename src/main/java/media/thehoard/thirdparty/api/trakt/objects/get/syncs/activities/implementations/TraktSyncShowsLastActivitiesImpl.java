...
public class TraktSyncShowsLastActivitiesImpl implements TraktSyncShowsLastActivities {
	...
	public boolean equals(Object o) {
		...
		TraktSyncShowsLastActivitiesImpl that = (TraktSyncShowsLastActivitiesImpl) o;
	...
	public String toString() {
		return "TraktSyncShowsLastActivities{" + "ratedAt=" + ratedAt + ", watchlistedAt=" + watchlistedAt + ", commentedAt=" + commentedAt + ", hiddenAt=" + hiddenAt + '}';
	}
}
