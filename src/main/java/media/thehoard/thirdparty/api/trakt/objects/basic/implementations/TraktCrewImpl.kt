...
data class TraktCrewImpl(override var production: List<TraktCrewMemberImpl> = listOf(),
                         override var art: List<TraktCrewMemberImpl> = listOf(),
                         override var crew: List<TraktCrewMemberImpl> = listOf(),
                         @SerializedName("costume & make-up") override var costumeAndMakeup: List<TraktCrewMemberImpl> = listOf(),
                         ...
                         @SerializedName("visual effects") override var visualEffects: List<TraktCrewMemberImpl> = listOf(),
                         override var editing: List<TraktCrewMemberImpl> = listOf()) : TraktCrew
