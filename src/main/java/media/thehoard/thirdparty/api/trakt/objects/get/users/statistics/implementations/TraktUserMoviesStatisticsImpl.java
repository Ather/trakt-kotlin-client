...
public class TraktUserMoviesStatisticsImpl implements TraktUserMoviesStatistics {
	...
	@Override
	public TraktUserMoviesStatistics withPlays(Integer plays) {
		this.plays = plays;
		return this;
	}
	...
	@Override
	public TraktUserMoviesStatistics withWatched(Integer watched) {
		this.watched = watched;
		return this;
	}
	...
	@Override
	public TraktUserMoviesStatistics withMinutes(Integer minutes) {
		this.minutes = minutes;
		return this;
	}
	...
	@Override
	public TraktUserMoviesStatistics withCollected(Integer collected) {
		this.collected = collected;
		return this;
	}
	...
	@Override
	public TraktUserMoviesStatistics withRatings(Integer ratings) {
		this.ratings = ratings;
		return this;
	}
	...
	@Override
	public TraktUserMoviesStatistics withComments(Integer comments) {
		this.comments = comments;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		TraktUserMoviesStatisticsImpl that = (TraktUserMoviesStatisticsImpl) o;
	...
	public String toString() {
		return "TraktUserMoviesStatistics{" + "plays=" + plays + ", watched=" + watched + ", minutes=" + minutes + ", collected=" + collected + ", ratings=" + ratings + ", comments=" + comments + '}';
	}
}
